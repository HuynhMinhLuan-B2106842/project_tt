...
export default function Header() {
      ...
      <div className="container mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-3">
          {isAuthenticated && user ? (
            ...
            <>
              <Button variant="outline" onClick={handleLoginClick}>Đăng nhập</Button>
  ...
  <div className="md:hidden fixed inset-0 z-50 bg-white pt-16 px-4">
    <nav className="flex flex-col gap-4">
      <Link href="/" onClick={() => setIsMobileMenuOpen(false)} className="py-2 border-b text-blue-900">Trang chủ</Link>
      <Link href="/quy-trinh" onClick={() => setIsMobileMenuOpen(false)} className="py-2 border-b text-blue-900">Quy trình khám</Link>
      <Link href="/dich-vu" onClick={() => setIsMobileMenuOpen(false)} className="py-2 border-b text-blue-900">Dịch vụ</Link>
      <Link href="/bac-si" onClick={() => setIsMobileMenuOpen(false)} className="py-2 border-b text-blue-900">Đội ngũ bác sĩ</Link>
      <Link href="/lien-he" onClick={() => setIsMobileMenuOpen(false)} className="py-2 border-b text-blue-900">Liên hệ</Link>
