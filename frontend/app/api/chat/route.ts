...
export async function POST(request: Request) {
  try {
    ...
    const responses: Record<string, string> = {
      ...
      "lịch khám": "Để đặt lịch khám, bạn có thể nhấn vào nút 'Đặt lịch khám' trên trang chủ hoặc gọi số 0123 456 789.",
      "giờ làm việc":
      ...
      "địa chỉ": "Phòng khám tọa lạc tại 123 Đường Khám Bệnh, Quận Y Tế, TP. Hồ Chí Minh. Điện thoại: 0123 456 789.",
      "liên hệ":
      ...
      "tạm biệt": "Tạm biệt! Hẹn gặp lại bạn tại phòng khám. Chúc bạn một ngày tốt lành!",
      covid:
      ...
      "bảo hiểm": "Phòng khám chấp nhận thẻ BHYT và các loại bảo hiểm y tế khác. Vui lòng mang theo thẻ khi đến khám.",
      "khẩn cấp":
