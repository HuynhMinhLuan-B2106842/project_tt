...
type _OptionalSchema = util.Satisfies<{
    anyOf: [ZuiJSONSchema, UndefinedSchema];
}, JSONSchema7>;
type _NullableSchema = util.Satisfies<{
    anyOf: [ZuiJSONSchema, NullSchema];
}, JSONSchema7>;
...
type ZuiJSONSchema = StringSchema | NumberSchema | BooleanSchema | UndefinedSchema | NullSchema | AnySchema | UnknownSchema | NeverSchema | ArraySchema | ObjectSchema | UnionSchema | DiscriminatedUnionSchema | IntersectionSchema | TupleSchema | RecordSchema | SetSchema | LiteralSchema | EnumSchema | RefSchema | OptionalSchema | NullableSchema;
 ...
 */
declare function toJSONSchema(schema: z.Schema): ZuiJSONSchema;
